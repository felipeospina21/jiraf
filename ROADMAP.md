...
- [ ] Multiple sprint support (backlog, future sprints) ([#22](https://github.com/felipeospina21/jiraf/issues/22))
- [ ] Extract Jira API interface for testing ([#20](https://github.com/felipeospina21/jiraf/issues/20))

### Low

- [ ] Enforce mutation keybind conventions ([#2](https://github.com/felipeospina21/jiraf/issues/2))
- [ ] Implement Jira ticket detailed view ([#1](https://github.com/felipeospina21/jiraf/issues/1))
