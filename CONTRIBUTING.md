# Contributing to jiraf

Thanks for your interest in contributing to jiraf! This document outlines the process and guidelines for contributing.
...
```bash
# Clone your fork
git clone https://github.com/<your-username>/jiraf.git
cd jiraf

# Build
go build ./...

# Run in dev mode (no Jira token needed)
go run . -dev
```
...
- Keep packages focused — UI components live in `internal/tui/`, API logic in `internal/jira/`
